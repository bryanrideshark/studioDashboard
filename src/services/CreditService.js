    ...
    return {
        ...
        execute: function() {
            CreditService = (function () {
                ...
                CreditService.prototype.validateCardNumber = function (cardNumber) {
                    return this.credit.validateCardNumber(cardNumber);
                };
                CreditService.prototype.validateCardExpiry = function (month, year) {
                    return this.credit.validateCardExpiry(month, year);
                };
                CreditService.prototype.validateCardCVC = function (cvc, type) {
                    return this.credit.validateCardCVC(cvc, type);
                };
                CreditService.prototype.parseCardType = function (cardNumber) {
                    return this.credit.parseCardType(cardNumber);
                };
                CreditService.prototype.parseCardExpiry = function (value) {
                    return this.credit.parseCardExpiry(value);
                };
                CreditService.prototype.formatCardNumber = function (value) {
                    return this.credit.formatCardNumber(value);
                };
                CreditService.prototype.formatCardExpiry = function (expiry) {
            ...
            exports_1("CreditService", CreditService);
        }
    }
});
