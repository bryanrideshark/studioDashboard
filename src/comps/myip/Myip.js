System.register(["@angular/core", "rxjs/Observable", "rxjs/add/operator/do", "rxjs/Rx", "@angular/http"], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, Observable_1, Rx_1, http_1;
    var MyIp;
    return {
        setters:[
            function (core_1_1) {
            ...
            MyIp = (function () {
                ...
                MyIp.prototype.getMyIp = function (url) {
                    ...
                    return Observable_1.Observable.create(function (observer) {
                        if (!_this.subject) {
                            _this.subject = new Rx_1.AsyncSubject();
