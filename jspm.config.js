SystemJS.config({
    ...
    map: {
        ...
        "@angular/http": "npm:@angular/http@2.0.0-rc.7/bundles/http.umd",
        "@angular/router": "npm:@angular/router@3.0.0-rc.3",
        "angular-router": "npm:@angular/router@3.0.0-rc.3"
    }
});
